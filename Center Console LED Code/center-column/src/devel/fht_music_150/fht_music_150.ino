/*******************************************************************************
 * fht_music_150.ino - 150 LED music visualizer with FHT
 *      Author:         Ray Sun 
...
void setup() {
    ...
    FastLED.addLeds<NEOPIXEL, OUT1_PIN>(leds, N_LEDS).setCorrection( TypicalLEDStrip );
    FastLED.addLeds<NEOPIXEL, OUT2_PIN>(leds, N_LEDS).setCorrection( TypicalLEDStrip );
